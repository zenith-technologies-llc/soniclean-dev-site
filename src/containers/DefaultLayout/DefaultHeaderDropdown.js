      ...
      <Dropdown nav isOpen={this.state.dropdownOpen} toggle={this.toggle}>
        ...
        <DropdownMenu right>
          <DropdownItem header tag="div" className="text-center"><strong>Account</strong></DropdownItem>
           <Link to="/contact"><DropdownItem> <i className="fa fa-envelope-o"></i>  Contact Support</DropdownItem></Link>
          ...
          <Link to="/settings"><DropdownItem><i className="fa fa-wrench"></i> Settings</DropdownItem> </Link>
