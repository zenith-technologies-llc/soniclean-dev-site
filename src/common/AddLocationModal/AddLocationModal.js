...
class AddLocationModal extends Component {
    ...
    render() {
        ...
        const { locationModal, openAddLocationModal, initialValues } = this.props

        return (
            <Modal isOpen={locationModal} toggle={() => openAddLocationModal(false)}
                className={'modal-primary ' + 'modal-lg'}>
                <ModalHeader toggle={() => openAddLocationModal(false)}>{initialValues ? 'Edit Store Location' :'Add Store Location'}</ModalHeader>
                <ModalBody>
                    <Card className="animated fadeIn mt-3 AddLocationModal">
                ...
                <ModalFooter>
                    <Button color="primary" onClick={() => openAddLocationModal(false)}>Submit</Button>
                    <Button color="danger" onClick={() => openAddLocationModal(false)}>Cancel</Button>
                </ModalFooter>
            </Modal>
        )
    }
